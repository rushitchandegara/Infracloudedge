...
const GetInTouch = () => {
  ...
  const handleSend = (e) => {
    ...
    const whatsappNumber = "917046058497";
    const text = `*New Inquiry*%0A*Name:* ${formData.name}%0A*Email:* ${formData.email}%0A*Company:* ${formData.company}%0A*Phone:* ${formData.phone}%0A*Message:* ${formData.message}`;
    
    window.open(`https://wa.me/${whatsappNumber}?text=${text}`, '_blank');
  };
  // --- Validation and Logic End ---
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-4">
                  {/* Social icons kept exactly as they were */}
              ...
              >
                ...
                <form className="space-y-6 relative z-10" onSubmit={handleSend}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        className="w-full bg-white dark:bg-[#050011]/80 border border-slate-300 dark:border-white/10 rounded-xl px-4 py-3.5 text-black dark:text-white placeholder-slate-400 focus:outline-none focus:border-fuchsia-500 focus:ring-1 focus:ring-fuchsia-500 transition-all shadow-sm dark:shadow-inner"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-white dark:bg-[#050011]/80 border border-slate-300 dark:border-white/10 rounded-xl px-4 py-3.5 text-black dark:text-white placeholder-slate-400 focus:outline-none focus:border-fuchsia-500 focus:ring-1 focus:ring-fuchsia-500 transition-all resize-none shadow-sm dark:shadow-inner"
                    ></textarea>
                  </div>
